...
from src.model.ae_model import autoencoder
...
def main(latent, fileout):
    ...
    ####### ---- #######
    model = autoencoder(params, len(hp_gene_set), [1024], [1024], latent)

    ####### ---- #######
    for train_dir in PAN_LIST[:1]:
        i = -1
        ...
        for target_dir in PAN_LIST:
            ...
            if 0:#target_dir == train_dir:
                utils.batch_integrate_plot(a_df, a_label, target_dir.split('/')[3] + '_each_AE_HP_total_log_1024-128.png')
...
if __name__ == '__main__':
    main(128, 'AE_HP_total_recon_1024_128_1.png')
    main(128, 'AE_HP_total_recon_1024_128_2.png')
    main(128, 'AE_HP_total_recon_1024_128_3.png')
    main(128, 'AE_HP_total_recon_1024_128_4.png')
    main(128, 'AE_HP_total_recon_1024_128_5.png')
    main(128, 'AE_HP_total_recon_1024_128_6.png')
    main(128, 'AE_HP_total_recon_1024_128_7.png')
    main(128, 'AE_HP_total_recon_1024_128_8.png')
    main(128, 'AE_HP_total_recon_1024_128_9.png')
    main(128, 'AE_HP_total_recon_1024_128_0.png')
